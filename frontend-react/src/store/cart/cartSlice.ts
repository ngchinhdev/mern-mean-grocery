...
import { getLocalStorage, removeItemLocalStorage, setLocalStorage } from "src/utils/helpers";
...
export const { addItem, increaseQuantity, decreaseQuantity, deleteItem, clearCartItems } = cartSlice.actions;
