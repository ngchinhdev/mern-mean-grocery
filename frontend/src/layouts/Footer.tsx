...
export default function Footer() {
  return (
    <footer className="mt-8 px-3 pb-16">
      ...
      <div className="mx-auto mt-5 max-w-screen-2xl rounded-lg border border-gray-50 bg-gray-50 px-4 shadow-sm sm:px-10">
        <div className="py-8">
      ...
      <div className="py-6 text-center">
        <p className="text-sm leading-6 text-gray-500">
          ...
          <br />
          <span>Clone by Nguyen Chinh with love 💖</span>
        </p>
      </div>
    </footer>
  );
